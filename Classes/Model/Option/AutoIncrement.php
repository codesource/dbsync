...
/**
 * Table auto increment option
 *
 * @author Matthias Toscanelli <m.toscanelli@code-source.ch>
 */
class AutoIncrement extends AbstractOption {
  ...
  public function create($type) {
    switch ($type) {
      case Type::MYSQL:
        return 'AUTO_INCREMENT=' . intval($this->value);
    }
    return '';
  }
  ...
  public function alter($type) {
    switch ($type) {
      case Type::MYSQL:
        return 'ALTER TABLE `' . $this->table->getName() . '` AUTO_INCREMENT=' . intval($this->value);
    }
    return '';
  }
  ...
  public function drop($type) {
    switch ($type) {
      case Type::MYSQL:
        ...
        return 'ALTER TABLE `' . $this->table->getName() . '` AUTO_INCREMENT=0';
    }
    return '';
  }
