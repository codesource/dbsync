...
/**
 * Table collation option
 *
 * @author Matthias Toscanelli <m.toscanelli@code-source.ch>
 */
class Collation extends AbstractOption {
  ...
  public function create($type) {
    switch ($type) {
      case Type::MYSQL:
        list($charset) = explode('_', $this->value);
        return 'DEFAULT CHARACTER SET ' . $charset . ' COLLATE ' . $this->value;
    }
    return '';
  }
  ...
  public function alter($type){
    switch ($type) {
      case Type::MYSQL:
        list($charset) = explode('_', $this->value);
        return 'ALTER TABLE `'.$this->table->getName().'` DEFAULT CHARACTER SET ' . $charset . ' COLLATE ' . $this->value;
    }
    return '';
  }
